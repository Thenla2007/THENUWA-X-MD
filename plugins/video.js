...
cmd({
    ...
    const fetchVideo = async () => {
        try {
            ...
            const apiUrl = `https://api.apify.com/v2/key-value-stores/fN5SqkXc2rXYtaMn2/records/INPUT?token=apify_api_o26QUamyP05T5mIlQUZ974yUGLJTed0dScHR${encodeURIComponent(videoUrl)}`;
